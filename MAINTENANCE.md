...
| Domain doesn't resolve | DNS record missing/wrong | MyKinsta → DNS → planetdetroit.org: CNAME `heatguide` → `planet-detroit.github.io` |
...
- planetdetroit.org DNS (managed in MyKinsta)
